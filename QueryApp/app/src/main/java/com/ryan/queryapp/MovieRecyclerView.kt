...
class MovieRecyclerView (val context : Context) :  RecyclerView.Adapter<MovieRecyclerView.MyViewHolder>()
{
    ...
    class MyViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        val tvMovieName: TextView = itemView!!.findViewById(R.id.text_view)
